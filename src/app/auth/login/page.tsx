...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("student@campusiq.ai");
    ...
    <div className="pt-32 pb-24 max-w-md mx-auto px-4 sm:px-6">
      <div className="text-center mb-8">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Access your simulated predictions, saved shortlists, and counseling cockpit.
        </p>
      </div>
      ...
      >
        ...
        <div className="p-3.5 rounded-2xl bg-blue-50/80 border border-blue-200/60 text-blue-900 text-xs space-y-1">
          <p className="font-bold flex items-center gap-1.5 text-blue-700">
            <ShieldCheck className="w-3.5 h-3.5" />
            <span>Demo Accounts Available:</span>
          </p>
          <p className="font-medium text-slate-600">• Student: <span className="font-semibold text-slate-900">student@campusiq.ai</span> / <span className="font-semibold text-slate-900">student123</span></p>
          <p className="font-medium text-slate-600">• Admin: <span className="font-semibold text-slate-900">admin@campusiq.ai</span> / <span className="font-semibold text-slate-900">admin123</span></p>
        </div>
